...
var recommend_sdk_module_exports = {};
__export(recommend_sdk_module_exports, {
  RecommendSDK: () => RecommendSDK,
  default: () => recommend_sdk_module_default
});
module.exports = __toCommonJS(recommend_sdk_module_exports);
